...
export const resolveFollowDirectionTarget = (direction: "prev" | "next"): Element | null => {
  return direction === "prev"
    ? (findElementWithRel("prev") ?? findMatchingLink(PREVIOUS_PATTERNS))
    : (findElementWithRel("next") ?? findMatchingLink(NEXT_PATTERNS));
};