...
export const getDefaultHintMarkerCSS = (
  ...
  return `${markerSelector}{transform:translate(0,0);transition:none !important;transition-duration:0ms !important;transition-property:none !important;display:inline-flex;align-items:center;gap:3px;max-width:calc(100vw - 16px);box-sizing:border-box;overflow:hidden;padding:2px 5px;border-radius:4px;background:#eab308;color:#2b1d00;font-family:"JetBrains Mono",ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,"Liberation Mono","Courier New",monospace;font-size:12px;font-weight:700;letter-spacing:.08em;line-height:1.2;box-shadow:0 1px 3px rgba(0,0,0,.28);white-space:nowrap;white-space-collapse:preserve;}${markerSelector} .nav-hint-marker-label{display:inline-flex;align-items:center;gap:0;min-width:0;overflow:hidden;}${markerSelector} .nav-hint-marker-icon{display:inline-flex;align-items:center;justify-content:center;flex:0 0 auto;width:1.15em;height:1.15em;border-radius:2px;background:rgba(43,29,0,.14);}${markerSelector} .nav-hint-marker-icon svg{display:block;width:.9em;height:.9em;}${thumbnailMarkerSelector}{transform:translate(0,0);gap:6px;padding:4px 10px;border-radius:6px;font-size:18px;font-weight:800;letter-spacing:.12em;line-height:1.1;box-shadow:0 3px 10px rgba(0,0,0,.4);}${thumbnailMarkerSelector} .nav-hint-marker-icon{width:1.1em;height:1.1em;border-radius:3px;background:rgba(43,29,0,.18);}${pendingSelector}{color:#000000;}${typedSelector}{color:#ffffff;}`;
};
