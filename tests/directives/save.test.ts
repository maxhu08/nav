...
export const directiveTestCase: DirectiveTestCase = {
  ...
  test: {
    ...
    ignores: [
      "<button type='button' aria-label='Images' class='sidebar-row library-browser-row'><svg aria-hidden='true'></svg><span>Images</span></button>",
      "<a href='/library' aria-label='Library'>Library</a>",
